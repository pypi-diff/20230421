# Comparing `tmp/waveforms-1.5.87.tar.gz` & `tmp/waveforms-1.5.89.tar.gz`
...
### Comparing `waveforms-1.5.87/waveforms/math/fit/resonator.py` & `waveforms-1.5.89/waveforms/math/fit/resonator.py`
...
### Comparing `waveforms-1.5.87/waveforms/qlisp/qasm/node/creg.py` & `waveforms-1.5.89/waveforms/qlisp/qasm/node/creg.py`
...
### Comparing `waveforms-1.5.87/waveforms/qlisp/qasm/node/if_.py` & `waveforms-1.5.89/waveforms/qlisp/qasm/node/if_.py`
...
### Comparing `waveforms-1.5.87/waveforms/qlisp/qasm/node/program.py` & `waveforms-1.5.89/waveforms/qlisp/qasm/node/program.py`
...
### Comparing `waveforms-1.5.87/waveforms/qlisp/simulator/mat.py` & `waveforms-1.5.89/waveforms/qlisp/simulator/mat.py`
...
### Comparing `waveforms-1.5.87/waveforms/quantum/tomo.py` & `waveforms-1.5.89/waveforms/quantum/tomo.py`
...
### Comparing `waveforms-1.5.87/waveforms/security/verify.py` & `waveforms-1.5.89/waveforms/security/verify.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/server/__init__.py` & `waveforms-1.5.89/waveforms/server/__init__.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/server/__main__.py` & `waveforms-1.5.89/waveforms/server/__main__.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/server/umsgpack.py` & `waveforms-1.5.89/waveforms/server/umsgpack.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/sys/chat.py` & `waveforms-1.5.89/waveforms/sys/chat.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/sys/device/basedevice.py` & `waveforms-1.5.89/waveforms/sys/device/basedevice.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/sys/device/loader.py` & `waveforms-1.5.89/waveforms/sys/device/loader.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/sys/device/utils.py` & `waveforms-1.5.89/waveforms/sys/device/utils.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/sys/drivers/FakeInstrument.py` & `waveforms-1.5.89/waveforms/sys/drivers/FakeInstrument.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/sys/ipy_events.py` & `waveforms-1.5.89/waveforms/sys/ipy_events.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/sys/net/dhcp.py` & `waveforms-1.5.89/waveforms/sys/net/dhcp.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/sys/net/dhcpd.py` & `waveforms-1.5.89/waveforms/sys/net/dhcpd.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/sys/net/kad.py` & `waveforms-1.5.89/waveforms/sys/net/kad.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/sys/net/kcp.py` & `waveforms-1.5.89/waveforms/sys/net/kcp.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/sys/progress.py` & `waveforms-1.5.89/waveforms/sys/progress.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/sys/storage/crud.py` & `waveforms-1.5.89/waveforms/sys/storage/crud.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/sys/storage/models.py` & `waveforms-1.5.89/waveforms/sys/storage/models.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/units/__init__.py` & `waveforms-1.5.89/waveforms/units/__init__.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/visualization/__init__.py` & `waveforms-1.5.89/waveforms/visualization/__init__.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/visualization/plot_layout.py` & `waveforms-1.5.89/waveforms/visualization/plot_layout.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/visualization/plot_seq.py` & `waveforms-1.5.89/waveforms/visualization/plot_seq.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/waveform.py` & `waveforms-1.5.89/waveforms/waveform.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms/waveform_parser.py` & `waveforms-1.5.89/waveforms/waveform_parser.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.87/waveforms.egg-info/PKG-INFO` & `waveforms-1.5.89/waveforms.egg-info/PKG-INFO`
...
### Comparing `waveforms-1.5.87/waveforms.egg-info/SOURCES.txt` & `waveforms-1.5.89/waveforms.egg-info/SOURCES.txt`
