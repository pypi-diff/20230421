# Comparing `tmp/prodia-python-1.2.tar.gz` & `tmp/prodia-python-1.5.tar.gz`
...
## Comparing `prodia-python-1.2.tar` & `prodia-python-1.5.tar`
...
### Comparing `prodia-python-1.2/LICENSE` & `prodia-python-1.5/LICENSE`

 * *Files identical despite different names*

### Comparing `prodia-python-1.2/README.md` & `prodia-python-1.5/README.md`

 * *Files identical despite different names*

### Comparing `prodia-python-1.2/prodia/run.py` & `prodia-python-1.5/prodia/run.py`
