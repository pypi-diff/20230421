# Comparing `tmp/liftcord-1.1.tar.gz` & `tmp/liftcord-2.3.0a0.tar.gz`
...
### Comparing `liftcord-1.1/README.rst` & `liftcord-2.3.0a0/README.rst`
...
### Comparing `liftcord-1.1/liftcord/colour.py` & `liftcord-2.3.0a0/liftcord/colour.py`
