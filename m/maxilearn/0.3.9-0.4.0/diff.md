# Comparing `tmp/maxilearn-0.3.9.tar.gz` & `tmp/maxilearn-0.4.0.tar.gz`
...
## Comparing `maxilearn-0.3.9.tar` & `maxilearn-0.4.0.tar`
...
### Comparing `maxilearn-0.3.9/LICENSE` & `maxilearn-0.4.0/LICENSE`
