# Comparing `tmp/tendril-utils-www-0.2.5.tar.gz` & `tmp/tendril-utils-www-0.2.6.tar.gz`
...
### Comparing `tendril-utils-www-0.2.5/.readthedocs.yml` & `tendril-utils-www-0.2.6/.readthedocs.yml`
