# Comparing `tmp/talos_install-0.2.0.dev340.tar.gz` & `tmp/talos_install-0.2.0.dev342.tar.gz`
...
### Comparing `talos_install-0.2.0.dev340/ansible/roles/nagios/files/overlay/opt/nagios/share/index.php` & `talos_install-0.2.0.dev342/ansible/roles/nagios/files/overlay/opt/nagios/share/index.php`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/nagios/files/overlay/opt/nagios/share/infobox.html` & `talos_install-0.2.0.dev342/ansible/roles/nagios/files/overlay/opt/nagios/share/infobox.html`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/nagios/files/overlay/opt/nagios/share/side.php` & `talos_install-0.2.0.dev342/ansible/roles/nagios/files/overlay/opt/nagios/share/side.php`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/nagios/files/overlay/opt/nagios/share/stylesheets/common.css` & `talos_install-0.2.0.dev342/ansible/roles/nagios/files/overlay/opt/nagios/share/stylesheets/common.css`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/nagios/files/overlay/opt/nagios/share/stylesheets/status.css` & `talos_install-0.2.0.dev342/ansible/roles/nagios/files/overlay/opt/nagios/share/stylesheets/status.css`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/nagios/files/overlay/opt/nagiosgraph/etc/fix-nagiosgraph-multiple-selection.sh` & `talos_install-0.2.0.dev342/ansible/roles/nagios/files/overlay/opt/nagiosgraph/etc/fix-nagiosgraph-multiple-selection.sh`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/nagios/files/overlay/usr/local/bin/start_nagios` & `talos_install-0.2.0.dev342/ansible/roles/nagios/files/overlay/usr/local/bin/start_nagios`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/nagios/tasks/build.yaml` & `talos_install-0.2.0.dev342/ansible/roles/nagios/tasks/build.yaml`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/nagios/tasks/misc.yaml` & `talos_install-0.2.0.dev342/ansible/roles/nagios/tasks/misc.yaml`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/nagios/tasks/run.yaml` & `talos_install-0.2.0.dev342/ansible/roles/nagios/tasks/run.yaml`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/nagios/templates/Dockerfile.j2` & `talos_install-0.2.0.dev342/ansible/roles/nagios/templates/Dockerfile.j2`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/nagios/templates/cgi.cfg.j2` & `talos_install-0.2.0.dev342/ansible/roles/nagios/templates/cgi.cfg.j2`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/nagios/templates/contacts.cfg.j2` & `talos_install-0.2.0.dev342/ansible/roles/nagios/templates/contacts.cfg.j2`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/nagios/templates/localhost.cfg.j2` & `talos_install-0.2.0.dev342/ansible/roles/nagios/templates/localhost.cfg.j2`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/opendcim/files/apache2.conf` & `talos_install-0.2.0.dev342/ansible/roles/opendcim/files/apache2.conf`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/opendcim/files/default.sql` & `talos_install-0.2.0.dev342/ansible/roles/opendcim/files/default.sql`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/opendcim/files/etc/opendcim/drawings/logo.png` & `talos_install-0.2.0.dev342/ansible/roles/opendcim/files/etc/opendcim/drawings/logo.png`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/opendcim/files/etc/opendcim/pictures/logo.png` & `talos_install-0.2.0.dev342/ansible/roles/opendcim/files/etc/opendcim/pictures/logo.png`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/opendcim/files/overlay/var/www/dcim/css/inventory.php` & `talos_install-0.2.0.dev342/ansible/roles/opendcim/files/overlay/var/www/dcim/css/inventory.php`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/opendcim/files/overlay/var/www/dcim/css/jquery-ui.css` & `talos_install-0.2.0.dev342/ansible/roles/opendcim/files/overlay/var/www/dcim/css/jquery-ui.css`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/opendcim/files/overlay/var/www/dcim/images/logo.png` & `talos_install-0.2.0.dev342/ansible/roles/opendcim/files/overlay/var/www/dcim/images/logo.png`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/opendcim/files/overlay/var/www/dcim/misc.inc.php` & `talos_install-0.2.0.dev342/ansible/roles/opendcim/files/overlay/var/www/dcim/misc.inc.php`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/opendcim/files/pre-conf.sh` & `talos_install-0.2.0.dev342/ansible/roles/opendcim/files/pre-conf.sh`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/opendcim/files/startup.sh` & `talos_install-0.2.0.dev342/ansible/roles/opendcim/files/startup.sh`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/opendcim/tasks/build.yaml` & `talos_install-0.2.0.dev342/ansible/roles/opendcim/tasks/build.yaml`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/opendcim/tasks/misc.yaml` & `talos_install-0.2.0.dev342/ansible/roles/opendcim/tasks/misc.yaml`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/opendcim/tasks/run.yaml` & `talos_install-0.2.0.dev342/ansible/roles/opendcim/tasks/run.yaml`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/opendcim/templates/Dockerfile.j2` & `talos_install-0.2.0.dev342/ansible/roles/opendcim/templates/Dockerfile.j2`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/opendcim/templates/first-run.sh.j2` & `talos_install-0.2.0.dev342/ansible/roles/opendcim/templates/first-run.sh.j2`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/os_tune/tasks/main.yaml` & `talos_install-0.2.0.dev342/ansible/roles/os_tune/tasks/main.yaml`
...
### Comparing `talos_install-0.2.0.dev340/ansible/roles/talos_users/tasks/main.yaml` & `talos_install-0.2.0.dev342/ansible/roles/talos_users/tasks/main.yaml`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/wiki/defaults/main.yaml` & `talos_install-0.2.0.dev342/ansible/roles/wiki/defaults/main.yaml`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/wiki/tasks/compose.yaml` & `talos_install-0.2.0.dev342/ansible/roles/wiki/tasks/compose.yaml`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/roles/wiki/templates/docker-compose.yml.j2` & `talos_install-0.2.0.dev342/ansible/roles/wiki/templates/docker-compose.yml.j2`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/ansible/site.yaml` & `talos_install-0.2.0.dev342/ansible/site.yaml`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/etc/globals.yaml` & `talos_install-0.2.0.dev342/etc/globals.yaml`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/etc/talos.yaml` & `talos_install-0.2.0.dev342/etc/talos.yaml`

 * *Files identical despite different names*

### Comparing `talos_install-0.2.0.dev340/setup.cfg` & `talos_install-0.2.0.dev342/setup.cfg`
...
@@ -24,14 +24,15 @@
 ...
 packages = 
 	talos_install
 data_files = 
 	share/talos_install/ansible = ansible/*
 	share/talos_install = setup.cfg
 	share/talos_install/etc = etc/*
+	share/talos_install/doc = README.md
 scripts = 
 	talos_install
...
### Comparing `talos_install-0.2.0.dev340/talos_install` & `talos_install-0.2.0.dev342/talos_install`
...
### Comparing `talos_install-0.2.0.dev340/talos_install.egg-info/PKG-INFO` & `talos_install-0.2.0.dev342/talos_install.egg-info/PKG-INFO`
...
### Comparing `talos_install-0.2.0.dev340/talos_install.egg-info/SOURCES.txt` & `talos_install-0.2.0.dev342/talos_install.egg-info/SOURCES.txt`
