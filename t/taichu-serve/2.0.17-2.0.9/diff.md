# Comparing `tmp/taichu-serve-2.0.17.tar.gz` & `tmp/taichu-serve-2.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "taichu-serve-2.0.17.tar", last modified: Fri Apr 21 10:01:00 2023, max compression
+gzip compressed data, was "taichu-serve-2.0.9.tar", last modified: Wed Apr 19 02:34:49 2023, max compression
```

## Comparing `taichu-serve-2.0.17.tar` & `taichu-serve-2.0.9.tar`

### file list

```diff
@@ -1,34 +1,35 @@
-drwxr-xr-x   0 chen       (501) staff       (20)        0 2023-04-21 10:01:00.431656 taichu-serve-2.0.17/
--rw-r--r--   0 chen       (501) staff       (20)      236 2023-04-21 10:01:00.431525 taichu-serve-2.0.17/PKG-INFO
--rw-r--r--   0 chen       (501) staff       (20)     6535 2023-04-21 02:12:16.000000 taichu-serve-2.0.17/README.md
--rw-r--r--   0 chen       (501) staff       (20)       38 2023-04-21 10:01:00.431697 taichu-serve-2.0.17/setup.cfg
--rw-r--r--   0 chen       (501) staff       (20)     1065 2023-04-21 10:00:51.000000 taichu-serve-2.0.17/setup.py
-drwxr-xr-x   0 chen       (501) staff       (20)        0 2023-04-21 10:01:00.429093 taichu-serve-2.0.17/taichu_serve/
--rw-r--r--   0 chen       (501) staff       (20)     3738 2023-04-21 07:11:30.000000 taichu-serve-2.0.17/taichu_serve/__init__.py
--rw-r--r--   0 chen       (501) staff       (20)     9573 2023-04-21 07:11:30.000000 taichu-serve-2.0.17/taichu_serve/app.py
--rw-r--r--   0 chen       (501) staff       (20)     8284 2023-04-21 09:53:18.000000 taichu-serve-2.0.17/taichu_serve/command.py
--rw-r--r--   0 chen       (501) staff       (20)      934 2023-04-18 09:03:28.000000 taichu-serve-2.0.17/taichu_serve/common.py
--rw-r--r--   0 chen       (501) staff       (20)     4829 2023-04-21 09:47:45.000000 taichu-serve-2.0.17/taichu_serve/dockerfile.py
--rw-r--r--   0 chen       (501) staff       (20)     1521 2023-04-14 04:52:00.000000 taichu-serve-2.0.17/taichu_serve/error_code.py
--rw-r--r--   0 chen       (501) staff       (20)     6336 2023-04-12 06:27:59.000000 taichu-serve-2.0.17/taichu_serve/grpc_predict_v2_pb2.py
--rw-r--r--   0 chen       (501) staff       (20)    13010 2023-04-13 09:06:46.000000 taichu-serve-2.0.17/taichu_serve/grpc_predict_v2_pb2_grpc.py
--rw-r--r--   0 chen       (501) staff       (20)     5042 2023-04-19 06:55:46.000000 taichu-serve-2.0.17/taichu_serve/grpc_server.py
--rw-r--r--   0 chen       (501) staff       (20)     2274 2023-04-21 09:59:46.000000 taichu-serve-2.0.17/taichu_serve/log.py
--rw-r--r--   0 chen       (501) staff       (20)     5471 2023-04-21 06:11:44.000000 taichu-serve-2.0.17/taichu_serve/model_server.py
--rw-r--r--   0 chen       (501) staff       (20)      205 2023-04-13 09:06:46.000000 taichu-serve-2.0.17/taichu_serve/ratelimiter.py
--rw-r--r--   0 chen       (501) staff       (20)     3171 2023-04-21 09:57:12.000000 taichu-serve-2.0.17/taichu_serve/settings.py
-drwxr-xr-x   0 chen       (501) staff       (20)        0 2023-04-21 10:01:00.430301 taichu-serve-2.0.17/taichu_serve/template/
--rw-r--r--   0 chen       (501) staff       (20)        0 2023-04-18 02:46:49.000000 taichu-serve-2.0.17/taichu_serve/template/__init__.py
--rw-r--r--   0 chen       (501) staff       (20)      833 2023-04-21 07:11:30.000000 taichu-serve-2.0.17/taichu_serve/template/customize_service.py
-drwxr-xr-x   0 chen       (501) staff       (20)        0 2023-04-21 10:01:00.431151 taichu-serve-2.0.17/taichu_serve/template/test/
--rw-r--r--   0 chen       (501) staff       (20)        0 2023-04-18 02:46:49.000000 taichu-serve-2.0.17/taichu_serve/template/test/__init__.py
--rw-r--r--   0 chen       (501) staff       (20)      691 2023-04-20 09:26:47.000000 taichu-serve-2.0.17/taichu_serve/template/test/grpc_client.py
--rw-r--r--   0 chen       (501) staff       (20)      286 2023-04-20 09:26:47.000000 taichu-serve-2.0.17/taichu_serve/template/test/http_client.py
--rw-r--r--   0 chen       (501) staff       (20)      932 2023-04-20 09:26:47.000000 taichu-serve-2.0.17/taichu_serve/template/test/stream_grpc_client.py
-drwxr-xr-x   0 chen       (501) staff       (20)        0 2023-04-21 10:01:00.430037 taichu-serve-2.0.17/taichu_serve.egg-info/
--rw-r--r--   0 chen       (501) staff       (20)      236 2023-04-21 10:01:00.000000 taichu-serve-2.0.17/taichu_serve.egg-info/PKG-INFO
--rw-r--r--   0 chen       (501) staff       (20)      838 2023-04-21 10:01:00.000000 taichu-serve-2.0.17/taichu_serve.egg-info/SOURCES.txt
--rw-r--r--   0 chen       (501) staff       (20)        1 2023-04-21 10:01:00.000000 taichu-serve-2.0.17/taichu_serve.egg-info/dependency_links.txt
--rw-r--r--   0 chen       (501) staff       (20)       58 2023-04-21 10:01:00.000000 taichu-serve-2.0.17/taichu_serve.egg-info/entry_points.txt
--rw-r--r--   0 chen       (501) staff       (20)       53 2023-04-21 10:01:00.000000 taichu-serve-2.0.17/taichu_serve.egg-info/requires.txt
--rw-r--r--   0 chen       (501) staff       (20)       13 2023-04-21 10:01:00.000000 taichu-serve-2.0.17/taichu_serve.egg-info/top_level.txt
...
### Comparing `taichu-serve-2.0.17/setup.py` & `taichu-serve-2.0.9/setup.py`
...
### Comparing `taichu-serve-2.0.17/taichu_serve/__init__.py` & `taichu-serve-2.0.9/taichu_serve/__init__.py`
...
### Comparing `taichu-serve-2.0.17/taichu_serve/app.py` & `taichu-serve-2.0.9/taichu_serve/app.py`
...
### Comparing `taichu-serve-2.0.17/taichu_serve/common.py` & `taichu-serve-2.0.9/taichu_serve/common.py`

 * *Files identical despite different names*

### Comparing `taichu-serve-2.0.17/taichu_serve/error_code.py` & `taichu-serve-2.0.9/taichu_serve/error_code.py`

 * *Files identical despite different names*

### Comparing `taichu-serve-2.0.17/taichu_serve/grpc_predict_v2_pb2.py` & `taichu-serve-2.0.9/taichu_serve/grpc_predict_v2_pb2.py`

 * *Files identical despite different names*

### Comparing `taichu-serve-2.0.17/taichu_serve/grpc_predict_v2_pb2_grpc.py` & `taichu-serve-2.0.9/taichu_serve/grpc_predict_v2_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `taichu-serve-2.0.17/taichu_serve/grpc_server.py` & `taichu-serve-2.0.9/taichu_serve/grpc_server.py`
...
### Comparing `taichu-serve-2.0.17/taichu_serve/log.py` & `taichu-serve-2.0.9/taichu_serve/log.py`
...
### Comparing `taichu-serve-2.0.17/taichu_serve/model_server.py` & `taichu-serve-2.0.9/taichu_serve/model_server.py`
...
### Comparing `taichu-serve-2.0.17/taichu_serve/template/test/grpc_client.py` & `taichu-serve-2.0.9/taichu_serve/template/test/grpc_client.py`
...
### Comparing `taichu-serve-2.0.17/taichu_serve/template/test/stream_grpc_client.py` & `taichu-serve-2.0.9/taichu_serve/template/test/stream_grpc_client.py`
...
### Comparing `taichu-serve-2.0.17/taichu_serve.egg-info/SOURCES.txt` & `taichu-serve-2.0.9/taichu_serve.egg-info/SOURCES.txt`
