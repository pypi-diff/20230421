# Comparing `tmp/crunchstat_summary-2.6.1.tar.gz` & `tmp/crunchstat_summary-2.6.2rc2.tar.gz`
...
## Comparing `crunchstat_summary-2.6.1.tar` & `crunchstat_summary-2.6.2rc2.tar`
...
### Comparing `crunchstat_summary-2.6.1/agpl-3.0.txt` & `crunchstat_summary-2.6.2rc2/agpl-3.0.txt`

 * *Files identical despite different names*

### Comparing `crunchstat_summary-2.6.1/arvados_version.py` & `crunchstat_summary-2.6.2rc2/arvados_version.py`

 * *Files identical despite different names*

### Comparing `crunchstat_summary-2.6.1/crunchstat_summary/command.py` & `crunchstat_summary-2.6.2rc2/crunchstat_summary/command.py`

 * *Files identical despite different names*

### Comparing `crunchstat_summary-2.6.1/crunchstat_summary/dygraphs.js` & `crunchstat_summary-2.6.2rc2/crunchstat_summary/dygraphs.js`

 * *Files identical despite different names*

### Comparing `crunchstat_summary-2.6.1/crunchstat_summary/dygraphs.py` & `crunchstat_summary-2.6.2rc2/crunchstat_summary/dygraphs.py`

 * *Files identical despite different names*

### Comparing `crunchstat_summary-2.6.1/crunchstat_summary/reader.py` & `crunchstat_summary-2.6.2rc2/crunchstat_summary/reader.py`

 * *Files identical despite different names*

### Comparing `crunchstat_summary-2.6.1/crunchstat_summary/summarizer.py` & `crunchstat_summary-2.6.2rc2/crunchstat_summary/summarizer.py`

 * *Files identical despite different names*

### Comparing `crunchstat_summary-2.6.1/crunchstat_summary/synchronizer.js` & `crunchstat_summary-2.6.2rc2/crunchstat_summary/synchronizer.js`

 * *Files identical despite different names*

### Comparing `crunchstat_summary-2.6.1/crunchstat_summary/webchart.py` & `crunchstat_summary-2.6.2rc2/crunchstat_summary/webchart.py`

 * *Files identical despite different names*

### Comparing `crunchstat_summary-2.6.1/crunchstat_summary.egg-info/SOURCES.txt` & `crunchstat_summary-2.6.2rc2/crunchstat_summary.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `crunchstat_summary-2.6.1/setup.py` & `crunchstat_summary-2.6.2rc2/setup.py`
