# Comparing `tmp/vmilog-py-0.5.0.tar.gz` & `tmp/vmilog-py-0.6.0.tar.gz`
...
## Comparing `vmilog-py-0.5.0.tar` & `vmilog-py-0.6.0.tar`
...
### Comparing `vmilog-py-0.5.0/LICENSE` & `vmilog-py-0.6.0/LICENSE`

 * *Files identical despite different names*

### Comparing `vmilog-py-0.5.0/PKG-INFO` & `vmilog-py-0.6.0/PKG-INFO`
...
### Comparing `vmilog-py-0.5.0/setup.py` & `vmilog-py-0.6.0/setup.py`
...
### Comparing `vmilog-py-0.5.0/src/vmi485tousb/_uartChannel.py` & `vmilog-py-0.6.0/src/vmi485tousb/_uartChannel.py`

 * *Files identical despite different names*

### Comparing `vmilog-py-0.5.0/src/vmilog/_logging.py` & `vmilog-py-0.6.0/src/vmilog/_logging.py`

 * *Files identical despite different names*

### Comparing `vmilog-py-0.5.0/src/vmilog_py.egg-info/PKG-INFO` & `vmilog-py-0.6.0/src/vmilog_py.egg-info/PKG-INFO`
