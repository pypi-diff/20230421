# Comparing `tmp/arkdata-1.0.4.tar.gz` & `tmp/arkdata-1.0.5.tar.gz`
...
### Comparing `arkdata-1.0.4/src/arkdata/database/configuration.py` & `arkdata-1.0.5/src/arkdata/database/configuration.py`
